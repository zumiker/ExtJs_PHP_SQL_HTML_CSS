...
if ($podl!='1' && $tur!='3')
{
	...
	if ($podl==1)
		{
		$sql="SELECT ABI_NUMBER, LASTNAME, FIRSTNAME, PATRONYMIC, HOST, TAWNAME_SMALL, KATEGORIA, DOC, PRIORITET, BALL, PRIKAZ, OJID
		...
		if ($OJID==1)
		$html .= "<td align='center' size='9'>Д</td>";
		else
...
//////////////////////////////////////////////// end	
		for ($j=0;$j<=0;$j++)
		{
			...
			if ($podl==1)
			{
			$sql="SELECT ABI_NUMBER, LASTNAME, FIRSTNAME, PATRONYMIC, HOST, TAWNAME_SMALL, KATEGORIA, DOC, BALL, KATEGOR, COLOR, PRIORITET, PRIKAZ, OJID " .
			" FROM ABIVIEW_PODVAL_24 " .
