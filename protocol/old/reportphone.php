...
if ($nab!='3'){
	...
	for ($i=0;$i<ora_numrows($cur);$i++){			
		...
		$s1 = "<table border='1' style='text-align:center; font-family: Verdana; font-size: 7px;'>
					...
					<tr>
						<td rowspan='2' align='center' width='8'><b>№<br> п/п</b></td>
						<td rowspan='2' align='center' width='25'><b>ФИО</b></td>
						<td rowspan='2' class='verticaltext'  align='center' width='24'><b>Телефоны</b></td>
						<td rowspan='2' align='center' width='10'><b>Сумма<br>баллов</b></td>
						<td rowspan='2' align='center' width='9'><b>Приоритет</b></td>
						<td rowspan='2' align='center' width='11'><b>Медаль</b></td>
						<td rowspan='2' align='center' width='13'><b>Документ</b></td>
						<td colspan='2' align='center' width='19'><b>Общежитие</b></td>
						<td rowspan='2' align='center' width='10' ><b>№ л.д.</b></td>
					</tr>
					<tr>
						<td align='center'  width='9'><b>Треб.</b></td>
						<td align='center'  width='10'><b>Выдел.</b></td>
					</tr>";
		...
		$html .= "<TABLE border='1'>
					<tr bgcolor='$col'>
						<td align='center' family='TimesNewRomanPSMT' width='8' size='10'>$num</td>
