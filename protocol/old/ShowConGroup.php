...
<button onClick='GetReportConEx(6,0)' style='width: 150px;'>Excel (31 июля) без цел.</button>
<br/>
...
<button onClick='GetReportConEx1(1,0)' style='width: 200px;'>Excel (Бюд.) с направлениями</button></td>
<button onClick='GetReportConEx1(1,1)' style='width: 240px;'>Подл. Excel (Бюд.) с направлениями</button></td>
<button onClick='GetReportCon(1,2)' style='width: 240px;'>Подл. (Бюд.) с подвалом</button></td>
</tr>