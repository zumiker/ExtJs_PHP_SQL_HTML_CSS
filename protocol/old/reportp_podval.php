...
$sql="SELECT ABI_NUMBER, LASTNAME, FIRSTNAME, PATRONYMIC, OJID, TAWNAME_SMALL, KATEGORIA, DOC, BALL, KATEGOR" .
		" FROM ABIVIEW_PODVAL_24 " .
		" WHERE $sql1  $sql3 AND KATEGOR IN (21,23) AND DOC='Подл' and tur_fix = $tur ORDER BY KATEGOR,BALL DESC, LASTNAME";
...
/*				$sql="SELECT ABI_NUMBER, LASTNAME, FIRSTNAME, PATRONYMIC FROM ABIVIEW_PODVAL_24 " .
				...
				$sql="SELECT ABI_NUMBER, LASTNAME, FIRSTNAME, PATRONYMIC, OJID, TAWNAME_SMALL, KATEGORIA, DOC, BALL, KATEGOR" .
						" FROM ABIVIEW_PODVAL_24 " .
						" WHERE $sql1  $sql3 AND KATEGOR IN (29,31) AND DOC='Подл' and tur_fix = $tur ORDER BY KATEGOR,BALL DESC, LASTNAME";
			}
			else
			{
