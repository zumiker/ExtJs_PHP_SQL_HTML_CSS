...
function FixTur()
{
 ...
 url=url+"?tur="+tur.value
 url=url+"&sid="+Math.random()
 document.getElementById("fix").innerHTML="<center><img src='loader.gif'/></center>" 
...
function GetReportConEx1(str1,str2)
{
 xmlHttp=GetXmlHttpObject()
 if (xmlHttp==null)
  {
