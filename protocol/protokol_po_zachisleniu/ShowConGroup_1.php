...
<button onClick='GetReportConEx1(1,0)' style='width: 240px;'>Excel (Бюд.) с направлениями</button>
...
<button onClick='GetReportConEx1(1,1)' style='width: 240px;'>Подл Excel (Бюд.) с направлениями</button>
...
<br/>
<button onClick='GetReportCon(6,0)' style='width: 150px;'>(30 июля) без цел.</button>
