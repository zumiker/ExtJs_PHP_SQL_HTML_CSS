...
//$html .= "<style> .verticaltext {layout-flow : vertical-ideographic; filter:flipH flipV;}</style> ";
...
if ($podl!='1' && $tur!='3')
{
	...
	if ($podl==1)
		...
		$s1 = "<table border='1' style='text-align:center; font-family: Verdana; font-size: 7px;'><tr><td colspan='99' align=center family='TimesNewRomanPSMT' size='7'><b>СПИСОК К ЗАЧИСЛЕНИЮ</td></b></tr>";
