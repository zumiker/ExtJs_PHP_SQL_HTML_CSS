...
//	$html .= "<tr><td colspan='99'><center><h2>АНКЕТНЫЕ ДАННЫЕ<br/>$header_date<br/></h2>$hdate<br/><br/></center></td></tr>"; 	
	$s1 .= 	"<tr>" .
			...
			"<td align='center' valign='middle' width='15'><b>№ <br/>л.д.</td>" .
			"<td align='center' valign='middle' width='80'><b>ФИО</td>" .
			"<td align='center' valign='middle' width='9'><b>Пол</td>" .
			"<td align='center' valign='middle' width='12'><b>Набор/</br>Прио-<br/>ритет</td>" .
			"<td align='center' valign='middle' width='12'><b>Общеж.</td>" .
			"<td align='center' valign='middle' width='14'><b>Медаль/</br>Льготн.</td>" .
			"<td align='center' valign='middle' width='11'><b>Год<br/>оконч<br/>ОУ</td>" .
			"<td align='center' valign='middle' width='16'><b>Документ<br/>атт/дипл</td>" .
			"<td align='center' valign='middle'><b>Заявлен<br/>рез-т</td>" .
//			"<td align='center' valign='middle'><b>Заявка на<br/>ЕГЭ/<br/>трад.</td>" .
			"<td align='center' valign='middle'><b>Заявка на<br/>трад.</td>" .
			"<td colspan='2' align='center' valign='middle'><b>Дата рожд.</td>" .
			"<td align='center' valign='middle'><b>Паспорт<br/>(Серия<br/>Номер)</td></tr>" .
			"<tr><td colspan='8' align='center' valign='middle'><b>Адрес</td>" .
			"<td align='center' valign='middle' width='19'><b>Телефон 1</td>" .
			"<td align='center' valign='middle' width='18'><b>Телефон 2</td>" .
			"<td align='center' valign='middle' width='10'><b>Экз. лист<br>выд.</td>" .
			"<td align='center' valign='middle' width='10'><b>Док-т получ.</td>" .
			"<td align='center' valign='middle'><b>Прим.</td></tr>";
...
//"                                                                                                                                              $d" .
						"<br/>$CONGROUP" .
						"<br/>Специальность: $SPCBRIFE</b></td></tr>"; 	
