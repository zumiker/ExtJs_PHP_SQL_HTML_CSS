...
$sql = "SELECT DISTINCT
		...
		WHERE facid='$divid'
			...
			$sql3
		ORDER BY $sql4";
//	--AND SPECID='$subid'	WHERE facid='$divid' AND CON_ID='$groid' AND SPECID='$subid' $wher1e $sql3  AND PRIORITET in (1,4,7) ORDER BY $sql4";
...
//	$sqlpodval="SELECT * FROM ABI_MINI_PODVAL WHERE facid='$divid' AND CON_ID='$groid' AND SPECID='$subid'";//CON_ID = '$id_con' AND SPECID = '$id_spec'";
	$sqlpodval="SELECT *
				...
				WHERE CON_ID='$groid'
					...
					";// --AND SPECID='$subid'    CON_ID = '$id_con' AND SPECID = '$id_spec'";
