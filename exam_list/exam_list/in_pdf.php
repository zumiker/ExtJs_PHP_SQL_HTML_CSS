...
$sql="SELECT DISTINCT predmet, TO_CHAR(kogda, 'DD.MM.YYYY') as kogda, ball100 FROM ABIVIEW_LISTOFEXAM WHERE abi_id=$abi_id ORDER BY kogda";//для вывода всех заявленных предметов (на 5-ти не будет подписи)
$cur=ora_do($conn,$sql);
