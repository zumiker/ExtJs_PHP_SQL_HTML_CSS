...
$worksheet->setColumn(0,1,3);
$worksheet->setColumn(0,2,3);
$worksheet->setColumn(0,3,3);
$worksheet->setColumn(0,4,3);
$worksheet->setColumn(0,5,3);
$worksheet->setColumn(0,6,3);
$worksheet->setColumn(0,7,3);
$worksheet->setColumn(0,8,3);
$worksheet->setColumn(0,9,3);
$worksheet->setColumn(0,10,3);
$worksheet->setColumn(0,11,3);
$worksheet->setColumn(0,12,3);
$worksheet->setColumn(0,13,3);
$worksheet->setColumn(0,14,3);
$worksheet->setColumn(0,15,3);
...
for ($i=0;$i<ora_numrows($cur);$i++)
		{
			...
			{$sql2="select sum(SEMESTR)SEMESTR, 
		 	...
		 	WHERE  DIVID='$kaf' AND YEAR_GROCODE='$god' AND STAT_ID IN (1,2) AND PREPID='$PREPID'";
