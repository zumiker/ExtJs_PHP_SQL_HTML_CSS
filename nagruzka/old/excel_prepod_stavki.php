...
$conn=ora_logon("GANGTEMP@IUSDB.DEVELOPERS","gdb");
 ...
 $sql="SELECT STAT_ID,STAT,BEZ,SUM_STAVKA,PROF,DOC,STAR,PREP,ASS,STAVKA,VSEGO
	      from Z_PREPOD_UMU WHERE DIVID='$kaf'
...
$sql = "SELECT sum(VSEGO) as VSEGO from Z_PREPOD_UMU WHERE DIVID='$kaf' and stat_id not in ( 3, 5 ) order by stat_id,stavka desc";
$cur = ora_do($conn,$sql);
