<?php
//echo " AND DATE_IN >= TO_DATE('$start', 'dd.mm.yyyy') AND DATE_IN <= TO_DATE('$end', 'dd.mm.yyyy') ";
...
*/			
//$yesterday = str2time($end);
//$time1=$yesterday+186400;
//$string2 = time2str($time1);
...
//	if ($id_fac=='9')
	/*	$sql="SELECT DISTINCT FAC, CONGROUP, ABI_NUMBER, LASTNAME, FIRSTNAME, PATRONYMIC, " .
				...
				$sql="SELECT DISTINCT FAC, CONGROUP, ABI_NUMBER, LASTNAME, FIRSTNAME, PATRONYMIC, " .
				"SEX, TO_CHAR(BIRTHDAY, 'dd.mm.yyyy'), PASNUMBER, decode(HOST,'Д','+','Н',''), FACID, CON_ID, " .
				"SPECID, NABOR, MUSOR, PRIORITET, " .
				"AWARD, decode(TAWNAME,'Д','+'), DATE_IN, ABI_ID, SPCBRIFE, STUFROM, POSTINDEX, ADDRESS, PHONE, PHONE2, EDUFINISH, AVGBALL, BALL100 " .
...
//	$html .= "<tr><td colspan='99'><center><h2>АНКЕТНЫЕ ДАННЫЕ<br/>$header_date<br/></h2>$hdate<br/><br/></center></td></tr>"; 	
	$s1 .= 	"<tr>" .// height='30'
			"<td family='TimesNewRomanPS-BoldMT' align='center' valign='middle' width='7' size='6'><b>№</td> " .
//			"<td align='center' valign='middle' width='10'><b> № </br>л.д.</td> " .
			"<td align='center' valign='middle' width='60'><b>ФИО</td> " .
//			"<td align='center' valign='middle' width='8'><b>Пол</td> " .
			"<td align='center' valign='middle' width='10'><b>Вступ.<br/>балл</td> " .
			"<td align='center' valign='middle' width='10'><b>Набор</td> " .
			"<td align='center' valign='middle' width='8'><b>Общ.</td> " .
			"<td align='center' valign='middle' width='9'><b>Дипл.<br>с отл</td> " .
			"<td align='center' valign='middle' width='8'><b>Ср.<br/>балл</td> " .
			"<td align='center' valign='middle' width='10'><b>Год<br/>оконч</td> " .
			"<td align='center' valign='middle' width='50'><b>Откуда</td> " .
//			"<td align='center' valign='middle' width='20' rowspan='2'><b>Телефон 1</td> " .
//			"<td align='center' valign='middle' width='20' rowspan='2'><b>Телефон 2</td> " .
//			"<td align='center' valign='middle'><b>Дата рожд.</td> " .
//			"<td align='center' valign='middle' width='15' rowspan='2' colspan='2'><b>Паспорт<br/>(Серия Номер)</td> " .
//			"</tr> " .
//			"<tr> " .
//			"<td colspan='7' align='center'>Адрес</td> " .
			"</tr> " ;
...
//		pdf_begin_page (int pdf object, float width, float height)
		...
		$BALL100 = ora_getcolumnnbsp($cur,28);
...
"                                                                                                                                              $d" .
						"<br/>$CONGROUP" .
						"<br/>.                                                                                         " .
						"Специальность: $SPCBRIFE</b></td></tr>";
//						"<br/>$header_date<br/></h2>$hdate<br/><br/></center></td></tr>"; 	
			$SPECID_OLD=$SPECID;	
			$col = "#ffffff";
		}*/
		...
		$k=$k+1;
		$html .=	"<tr bgcolor='$col'> " .
					//"<td align='center' valign='middle' size='10'>$k</td> " .
					"<td align='center' valign='middle' size='10'>$num</td>" .
//					"<td align='center' valign='middle' height='12' nowrap>$ABI_NUMBER</td> " .
...
//					"<td align='center' valign='middle' size='8'>$SEX</td> " .
		...
		//else
//			$html .=//"<td align='center' valign='middle' size='8' rowspan='2'>$PHONE </td> " .
					//"<td align='center' valign='middle' size='8' rowspan='2'>$PHONE2 </td> " .//"<td align='center'>111 $tmp1 /<br>$tmp2</td>";
//					"<td align='center' valign='middle'>$BIRTHDAY </td> " ;
					//"<td align='center' valign='middle' size='8' rowspan='2'>$PASNUMBER</td> " .
					//"<tr bgcolor='$col'><td colspan='7' align='center' valign='middle' height='13'> $POSTINDEX $ADDRESS</td> " ;
